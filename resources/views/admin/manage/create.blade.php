...
<div class="mt-5">
  <h3 class="py-3">Create New Management</h3>

      <form class="form-group" action="{{route('manage.store')}}" method="post" enctype="multipart/form-data">
        @csrf
            <div class="mt-4">
            ...
            <div class="mt-4">
               <label for="image">Image for Management </label>

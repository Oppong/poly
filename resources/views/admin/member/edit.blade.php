...
<div class="mt-5">
  <h3 class="py-3">Edit Member</h3>

      <form class="form-group" action="{{route('member.update', $member->id)}}" method="post" enctype="multipart/form-data">
        @csrf
            <div class="mt-4">
            ...
            <div class="mt-4">
              ...
              <textarea name="description" rows="8" cols="80" class="form-control" id="description" >{{$member->description}}</textarea>
              @error('description')<div class="alert alert-danger">{{ $message }}</div>@enderror
            </div>

            <div class="mt-4">
              <label for="music_part">Music Part</label>
              <input type="text" name="music_part" id="music_part" class="form-control" value="{{$member->music_part}}">
